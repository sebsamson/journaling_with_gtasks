...
- The sheet is standalone but if you want to edit the code, you will need to use the [App Script](https://developers.google.com/apps-script/overview?hl=en) Editor on the Sheet under "Extensions"
